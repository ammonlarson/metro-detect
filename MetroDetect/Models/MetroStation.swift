...
extension MetroStation {
    // M1 + M2 shared
    static let vanlose = MetroStation(name: "Vanløse", coordinate: .init(latitude: 55.6830, longitude: 12.4713), lines: [.m1, .m2])
    ...
    // M3 + M4 shared
    static let orientkaj = MetroStation(name: "Orientkaj", coordinate: .init(latitude: 55.7126, longitude: 12.6028), lines: [.m3, .m4])
    static let nordhavn = MetroStation(name: "Nordhavn", coordinate: .init(latitude: 55.7073, longitude: 12.5953), lines: [.m3, .m4])
    static let poulHenningsenPlads = MetroStation(name: "Poul Henningsens Plads", coordinate: .init(latitude: 55.7029, longitude: 12.5875), lines: [.m3, .m4])
    static let osterport = MetroStation(name: "Østerport", coordinate: .init(latitude: 55.7064, longitude: 12.5749), lines: [.m3, .m4])
    ...
    static let gammelStrand = MetroStation(name: "Gammel Strand", coordinate: .init(latitude: 55.6780, longitude: 12.5780), lines: [.m3, .m4])
